                        ...
                        <div class="profile-left">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-main">
                                    <img src="{{$author->profile->getAvatar()}}" class="img-circle" alt="Avatar" width="100">
                                    <h3 class="name">{{$author->profile->nama}}</h3>
                            ...
                            <div class="profile-detail">
                                <div class="profile-info">
                                    ...
                                    <ul class="list-unstyled list-justify">
                                        ...
                                        <li>Email <span>{{$author->email}}</span></li>
                                    </ul>
                                </div>
                                <div class="text-center">
                                    <a href="/profile/{{$author->profile->id}}/edit" class="btn btn-primary">Edit Profile</a>
                                </div>
                            </div>
                            <!-- END PROFILE DETAIL -->
                        </div>

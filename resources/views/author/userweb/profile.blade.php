                        ...
                        <div class="profile-left">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-main">
                                    <img src="{{$user->getAvatar()}}" class="img-circle" alt="Avatar" width="120">
                                    <h3 class="name">{{$user->nama}}</h3>
                                    <span class="online-status status-available">{{$user->nama_panggilan}}</span>
                                </div>
                            ...
                            <div class="profile-detail">
                                ...
                                <div class="text-center"><a href="/userweb/{{$user->id}}/edit" class="btn btn-warning">Edit Profile</a></div>
                            </div>
                            <!-- END PROFILE DETAIL -->
                        </div>
                        <!-- END LEFT COLUMN -->
